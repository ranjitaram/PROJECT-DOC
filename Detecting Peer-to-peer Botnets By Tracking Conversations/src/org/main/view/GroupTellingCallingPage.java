 ...
 * @author ashish
 */
public class GroupTellingCallingPage extends javax.swing.JFrame {

    /**
     * Creates new form GroupTallyCallingPage
     */
    public GroupTellingCallingPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Group TeleCalling");
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(255, 237, 204));

        subPanel.setBackground(new java.awt.Color(255, 237, 204));
        subPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "GROUP TALLY CALLING", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Verdana", 0, 12), new java.awt.Color(255, 153, 0))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroupTellingCallingPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
